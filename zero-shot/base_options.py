...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--weak", type=bool, default=True, help="weakly supervised training"
        )
        self.parser.add_argument(
            "--shot", type=int, default=2, help="few-shot learning"
        )
        ...
        self.parser.add_argument(
            "--dataset_name", type=str, default="LLP", help="name of the dataset"
        )
        self.parser.add_argument(
