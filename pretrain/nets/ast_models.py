...
class ASTModel(nn.Module):
    ...
    def __init__(
        ...
        # now load a model that is pretrained on both ImageNet and AudioSet
            ...
            sd = torch.load(
                "./pretrained_weight/audioset_10_10_0.4593.pth", map_location=device
            )
            ...
            # for 1 sec
            # audio_model = ASTModel(label_dim=527, fstride=fstride, tstride=tstride, input_fdim=128, input_tdim=102, imagenet_pretrain=False, audioset_pretrain=False, model_size='base384', verbose=False)
    ...
    @autocast()
    def forward(self, x, additional_patch=None):
        """
