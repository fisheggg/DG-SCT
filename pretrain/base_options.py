...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--weak", type=bool, default=False, help="weakly supervised training"
        )
        self.parser.add_argument(
            "--shot", type=int, default=0, help="few-shot learning"
        )
        ...
        self.parser.add_argument(
            "--dataset_name", type=str, default="vggsound", help="name of the dataset"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=1,
            help="classification tasks or AVE tasks",
        )
