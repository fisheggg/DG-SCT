...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--video_dir", type=str, default="data/feats/res152/", help="video dir"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--label_train",
            type=str,
            default="data/AVVP_train.csv",
            help="weak train csv file",
        )
        self.parser.add_argument(
            "--label_val",
            type=str,
            default="data/AVVP_val_pd.csv",
            help="weak val csv file",
        )
        self.parser.add_argument(
            "--label_test",
            type=str,
            default="data/AVVP_test_pd.csv",
        ...
        self.parser.add_argument(
            "--seed", type=int, default=3, metavar="S", help="random seed (default: 1)"
        )
        self.parser.add_argument(
            "--log-interval",
            type=int,
        ...
        self.parser.add_argument(
            "--checkpoint", type=str, default="mm_best", help="save model name"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument("--tmp", type=float, default=0.5, help="video dir")
        self.parser.add_argument("--smooth", type=float, default=1, help="video dir")
        ### yb param ##
        self.parser.add_argument(
        ...
        self.parser.add_argument("--decay", type=float, default=0.1, help="decay rate")
        self.parser.add_argument(
        ...
        self.parser.add_argument("--ybloss", type=int, default=1, help="decay rate")

        ### for transformer ###
        self.parser.add_argument("--num_layer", type=int, default=1, help="num layer")
        self.parser.add_argument("--num_head", type=int, default=1, help="num layer")
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--is_audio_adapter_p3", type=int, default=0, help="TF audio adapter"
        )
        ...
        self.parser.add_argument(
            "--num_tokens", type=int, default=2, help="num of MBT tokens"
        )
        ...
        self.parser.add_argument(
            "--ViT", type=str, default="ViT-B/32", help="name of Clip backbone"
        )
        self.parser.add_argument(
            "--N_CTX", type=int, default=4, help="number of context tokens"
        )
        self.parser.add_argument(
            "--CTX_INIT",
            type=str,
            default="a photo of a",
            help="Initialization of context tokens",
        )
        self.parser.add_argument("--CSC", type=bool, default=False)
        self.parser.add_argument(
            "--class_token_position", type=str, default="end", help="end, middle, front"
        )
        self.parser.add_argument(
            "--weak", type=int, default=0, help="weakly supervised training"
        )
        self.parser.add_argument("--classification", type=int, default=0)
        self.parser.add_argument(
            "--shot", type=int, default=16, help="few-shot learning"
        )

        self.parser.add_argument("--syncBN", type=bool, default=True)
        self.parser.add_argument("--device", type=str, default="cuda")
        self.parser.add_argument(
            "--world-size", type=int, default=4, help="number of distributed processes"
        )
        self.parser.add_argument(
            "--dist-url",
            type=str,
        ...
        self.parser.add_argument(
            "--dataset_name", type=str, default="AVE", help="name of the dataset"
        )
        self.parser.add_argument(
            "--resume", type=str, default="", help="name of the resume checkpoint"
        )
