...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--label_train",
            type=str,
            default="data/AVQA/json/avqa-train.json",
            help="train csv file",
        )
        self.parser.add_argument(
            "--label_val",
            type=str,
            default="data/AVQA/json/avqa-val.json",
            help="val csv file",
        )
        self.parser.add_argument(
            "--label_test",
            type=str,
            default="data/AVQA/json/avqa-test.json",
            help="test csv file",
        )
        self.parser.add_argument(
            "--batch-size",
        ...
        self.parser.add_argument(
            "--num_workers", type=int, default=8, help="worker for dataloader"
        )
        ...
        self.parser.add_argument(
            "--num_conv_group", type=int, default=4, help="group conv"
        )
