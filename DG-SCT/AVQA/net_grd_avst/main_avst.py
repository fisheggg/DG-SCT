...
def train(args, model, train_loader, optimizer, criterion, epoch):
    ...
    for batch_idx, sample in enumerate(train_loader):
        visual_posi, visual_nega, target, question, wave = (
    ...
    with torch.no_grad():
        for batch_idx, sample in enumerate(val_loader):
            ...
            preds_qa, out_match_posi, out_match_nega = model(
                wave, visual_posi, visual_nega, question, mixup_lambda=mixup_lambda
            )
...
def main():
    ...
    if args.mode == "train":
        ...
        test_loader = DataLoader(
            test_dataset, batch_size=1, shuffle=False, num_workers=16, pin_memory=True
        )
