...
class BaseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--checkpoint", type=str, default="best", help="save model name"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--audio_folder",
            type=str,
            default="/AVE_Dataset/raw_audio",
            help="raw audio path",
        )
        self.parser.add_argument(
            "--video_folder",
            type=str,
            default="data/AVE/frames",
        ...
        self.parser.add_argument(
            "--num_workers", type=int, default=0, help="worker for dataloader"
        )
        ...
        self.parser.add_argument(
            "--Adapter_downsample", type=int, default=16, help="tune top k"
        )
        ...
        self.parser.add_argument(
            "--is_bn", type=int, default=0, help="TF audio adapter"
        )
        self.parser.add_argument(
            "--is_gate", type=int, default=0, help="TF audio adapter"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--is_fusion_before", type=int, default=0, help="TF Vit"
        )
        ...
        self.parser.add_argument(
            "--backbone_type", type=str, help="the backbone of htsat"
        )
