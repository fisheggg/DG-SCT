...
class BaseOptions:
    ...
    def initialize(self):
        self.parser.add_argument(
            "--session_name", default="MS3", type=str, help="the S4 setting"
        )
        self.parser.add_argument(
            "--visual_backbone",
            default="resnet",
        ...
        self.parser.add_argument(
            "--weights", type=str, default="", help="path of trained model"
        )
        ...
        self.parser.add_argument(
            "--tpavi_vv_flag", type=int, default=0, help="visual-visual self-attention"
        )
        self.parser.add_argument(
            "--tpavi_va_flag", type=int, default=1, help="visual-audio cross-attention"
        )
        ...
        self.parser.add_argument(
            "--Adapter_downsample", type=int, default=2, help="tune top k"
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            ...
            type=str,
            default="audioset",
            help="the backbone of htsat",
        )
        self.parser.add_argument(
            "--gamma", type=float, default=0.1, help="the hyperparameter"
        )
